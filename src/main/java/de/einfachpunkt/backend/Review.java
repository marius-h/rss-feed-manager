...
public class Review implements Serializable {
     ...
     *            Last review date
     * @param feedItem
     *            FeedItem of beverage
     * @param count
     *            Times tasted
     */
    public Review(int score, String name, LocalDate date, FeedItem feedItem,
            int count) {
        this.score = score;
        this.name = name;
        this.date = date;
        //this.FeedItem = new FeedItem(feedItem);
        this.count = count;
    }
    ...
    public Review(Review other) {
        this(other.getScore(), other.getName(), other.getDate(),
                other.getFeedItem(), other.getCount());
        this.id = other.getId();
    }
    ...
    /**
     * Gets the value of FeedItem
     *
     * @return the value of FeedItem
     */
    ...
    /**
     * Sets the value of FeedItem
     *
     * @param FeedItem
     *            new value of FeedItem
     */
    ...
    public String toString() {
        ...
        return "Review{" + "id=" + getId() + ", score=" + getScore() + ", name="
                + getName() + ", FeedItem=" + getFeedItem() + ", date="
