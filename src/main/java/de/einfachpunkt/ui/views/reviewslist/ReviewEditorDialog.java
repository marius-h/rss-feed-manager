...
//            .getInstance();
    ...
    private ComboBox<FeedItem> categoryBox = new ComboBox<>();
    ...
    private void createCategoryBox() {
        categoryBox.setLabel("FeedItem");
        categoryBox.setRequired(true);
        categoryBox.setItemLabelGenerator(FeedItem::getTitle);
...
//                .bind(Review::getNewsModel, Review::setNewsModel);
    }
